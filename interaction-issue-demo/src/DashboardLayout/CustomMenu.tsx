...
import { makeBorderSize, makeSize, makeSpace } from '@razorpay/blade/utils';
...
const MenuTrigger = React.forwardRef<HTMLButtonElement, { children: string; className?: string; onMouseOver?: () => void; onMouseOut?: () => void }>(
